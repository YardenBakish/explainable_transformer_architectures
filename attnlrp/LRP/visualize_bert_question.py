...
from lxt.models.bert_PE import BertForQuestionAnswering, attnlrp
from lxt.utils import pdf_heatmap, clean_tokens

path = "deepset/bert-base-cased-squad2"
model = BertForQuestionAnswering.from_pretrained(path, torch_dtype=torch.bfloat16, device_map="cuda", attn_implementation="eager", low_cpu_mem_usage = True)
...
output_logits = model(inputs_embeds=input_embeds.requires_grad_()).end_logits
#print(output_logits)
max_logits, max_indices = torch.max(output_logits, dim=1)
