...
#YARDEN
def apply_rotary_pos_emb(q, k, cos, sin,detachPE, position_ids=None, unsqueeze_dim=1):
...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        #print(detachPE)
        query_states, key_states = apply_rotary_pos_emb(query_states, key_states, cos, sin,detachPE)
