...
model = MixtralForCausalLM.from_pretrained(path,quantization_config=quantization_config, use_safetensors=True, torch_dtype=torch.bfloat16, device_map="cuda",  low_cpu_mem_usage = True)
