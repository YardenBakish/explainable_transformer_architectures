...
class CustomMultiheadDiffAttn(nn.Module):
    def __init__(self, dim, index, num_heads=6, qkv_bias=False,attn_drop=0., proj_drop=0., 
        ...
        self.isWithAttnNorm = isWithAttnNorm

        # A = Q*K^T
        self.matmul1a = einsum('bhid,bhjd->bhij')
        self.matmul1b = einsum('bhid,bhjd->bhij')
        ...
        self.attn_drop2 = Dropout(attn_drop)
    ...
    def forward(self, x):
        ...
        attn1 = self.attn_activation1(dots1)
