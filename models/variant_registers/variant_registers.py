...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        register_tokens = self.registers.expand(B, -1, -1)
    ...
    def relprop(self, cam=None,method="transformer_attribution", conv_prop_rule = None, cp_rule = False, is_ablation=False, start_layer=0, **kwargs):
        # print(kwargs)
        ...
        if method   == "custom_lrp":
            ...
            if 'POS_ENC' in method:
                ...
                pos_cam = pos_cam[:,  self.num_registers +1:, :]
            ...
            cam = cam[:, 0, self.num_registers +1:]
            return cam
        ...
        # our method, method name grad is legacy
            ...
            cam = rollout[:, 0, self.num_registers +1:]
            return cam
